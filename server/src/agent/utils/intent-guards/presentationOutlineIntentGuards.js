...
import { isHtmlProjectDeliverable } from "../../policies/delivery/htmlProjectDeliveryPolicy.js";
...
export function isPresentationOutlineRequest(query = "") {
  ...
  // Fiche/guide nominal déjà cadré → pas un menu de formats / plan slides
  if (isExplicitNominalDocumentDeliverable(query)) return false;
